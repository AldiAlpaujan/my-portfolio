...
<template>
    <section class="pt-28 pb-32">
        <div class="container">
            <div class="flex flex-wrap items-center">
                <div class="w-full px-4 self-start md:w-1/2 lg:w-1/3">
                ...
                <div class="w-full px-4 md:w-1/2 lg:ml-20">
                    ...
                    <h2 class="font-bold text-heading text-3xl max-w-sm mb-4">
                        Mari, bangun aplikasi bersama saya!
                    </h2>
                    <p class="font-medium text-base text-body mb-8">
                    ...
                    <h4 class="font-bold  text-heading text-2xl mb-3">
                        Mari Berteman dan Berkolaborasi!
                    </h4>
                    <p class="font-medium text-base text-body mb-4">
